...
//        val adapter = Second_Recyclerview_Adapter(listData[position].items, HeartMajor_list())
...
class Major_RecyclerViewAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: MajorActivity.Recycler_item_out) {
            ...
            recyclerView.adapter = Second_Recyclerview_Adapter(item.items, HeartMajor_list())
